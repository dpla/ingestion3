...
def build_batch_script(hubs, batch_log, gha_actor="", skipped_hubs=None):
...
def fire_batch(hubs, batch_log, skipped_hubs=None):
...
def main():
    ...
    fire_batch(hubs, batch_log, skipped_hubs=skipped)
