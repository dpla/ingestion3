...
trait MarcXmlMapping extends XmlExtractor {
  /**
  ...
  /**
    ...
    */
  def controlfield(data: NodeSeq, tags: Seq[String]): NodeSeq =
  ...
  /**
    ...
    */
  def controlAt(data: NodeSeq, tag: String, index: Int): Seq[Char] =
    Try {
  ...
  /**
    ...
    */
  def leader(data: NodeSeq): String =
  ...
  /**
    ...
    * @return       Option[Char] character if found
    */
  def leaderAt(data: NodeSeq, index: Int): Option[Char] = {
    Try {
  ...
  def extractMarcLeaderType(data: NodeSeq): Option[String] = {
  ...
  /**
    * Extract date from MARC controlfield.
    * The tag of the controlfield is 008.
    *
    * @param data The metadata record
    * @return
    */
  def extractMarcControlDate(data: NodeSeq): Seq[String] = {
