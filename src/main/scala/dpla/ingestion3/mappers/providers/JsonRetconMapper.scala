...
import dpla.ingestion3.model.{DcmiTypeCollection, DplaPlace, EdmAgent, EdmTimeSpan, EdmWebResource, LiteralOrUri, SkosConcept, URI, eitherStringOrUri, nameOnlyAgent, nameOnlyCollection, nameOnlyConcept, nameOnlyPlace, stringOnlyTimeSpan}
import dpla.ingestion3.utils.Utils
import org.json4s
import org.json4s.JValue

class JsonRetconMapper extends JsonMapping with JsonExtractor {
