...
/**
  ...
  * @param text
  */
case class ApiSource(queryParams: Map[String, String],
                     url: Option[String] = None,
                     text: Option[String] = None) extends ApiResponse
...
case class ApiError(message: String,
                    errorSource: ApiSource) extends ApiResponse
