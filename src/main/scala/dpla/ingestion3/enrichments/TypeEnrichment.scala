...
class TypeEnrichment extends VocabEnrichment[String] {
  ...
  private val DcmiTypeMap: Map[String, IRI] = Map(
    ...
    "calotype print (positive)" -> dcmiType.Image,
    ...
    "oral history" -> dcmiType.Sound,
    "oral histories" -> dcmiType.Sound,
    ...
    "photochromolithograph" -> dcmiType.Image,
    "photograph" -> dcmiType.Image,
    "photographs" -> dcmiType.Image,
    "photographic postcard" -> dcmiType.Image,
    "photographic print (photograph)" -> dcmiType.Image,
    "photogravure" -> dcmiType.Image,
    "photomechanical print" -> dcmiType.Image,
    "phototype" -> dcmiType.Image,
    "physical object" -> dcmiType.PhysicalObject,
    "physicalobject" -> dcmiType.PhysicalObject,
    "picture postcard" -> dcmiType.Image,
    "portrait" -> dcmiType.Image,
    "portraits" -> dcmiType.Image,
    "postcard" -> dcmiType.Image,
    "postcards" -> dcmiType.Image,
