...
/** Contains type definitions that express cardinality of fields and a union
  * type for fields that can be literals or uris.
  */
object DplaMapData {
...
/** The aggregation of attributes that apply to the described resource as a
  * whole, grouped from edm:WebResource and dpla:SourceResource.
  */
...
/** dpla:SourceResource is a subclass of "edm:ProvidedCHO," which comprises the
  * described resources (in EDM called "cultural heritage objects") about which
  * DPLA collects descriptions. It is here that attributes of the described
  * resources are located, not the digital representations of them.
  */
